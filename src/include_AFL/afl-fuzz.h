...
struct queue_entry {
  ...
  u32 walk_len;                         /* Length of the automaton walk     */
...
typedef struct afl_state {
  ...
  /*Gramatron-specific state variables*/ 
  state *pda;                         /* Entry point for in-memory representation of FSA*/ 
  s32 numstates;                      /* Specify the number of states */

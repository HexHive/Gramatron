...
// #define STATES 63// Set this as `numstates` + 1 where `numstates` is retrieved from gen automata json
//
...
#define FLUSH_INTERVAL 3600 // Inputs that gave new coverage will be dumped every FLUSH_INTERVAL seconds
...
//   Candidate* cand;                     /* Preprocessed info about the candidate to allow for faster mutations*/
// 
//   u8* fname;                          /* File name for the test case      */
//   u32 len;                            /* Input length                     */
//   UT_array** recur_idx;               /* Keeps track of recursive feature indices*/
// 
